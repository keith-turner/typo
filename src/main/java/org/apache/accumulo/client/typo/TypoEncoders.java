...
public class TypoEncoders<RT,CFT,CQT,VT> {
  LexEncoder<RT> rowLexEnc;
  LexEncoder<CFT> colfLexEnc;
  LexEncoder<CQT> colqLexEnc;
  Encoder<VT> valEnc;
  
  public TypoEncoders(LexEncoder<RT> rowLexEnc, LexEncoder<CFT> colfLexEnc, LexEncoder<CQT> colqLexEnc, Encoder<VT> valEnc) {
